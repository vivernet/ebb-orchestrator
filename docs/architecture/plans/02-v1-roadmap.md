...
|---|---|---|
| 1 | `2026-09-16-foundation-persistence.md` | Backend стартует и имеет миграции SQLite, Outbox/Jobs, health/SSE и защищённый от сбоев каркас запуска |
| 2 | `2026-09-16-domain-workflow-scheduler.md` | Project/Epic/Task/Approval/Workflow/Scheduler/Recovery работают сквозным образом на FakeAgentRuntime |
| 3 | `2026-09-16-git-execution-security.md` | Реальные Git/worktree, Action Gateway, Permission Engine, Local Execution и границы безопасности |
| 4 | `2026-09-16-hermes-autonomous-task.md` | Hermes Developer → Reviewer → QA → Integration выполняют standalone Task до ручного одобрение слияния |
| 5 | `2026-09-16-planning-epics-context-knowledge.md` | Coordinator/PM/Architect, жизненный цикл Epic, Context Engine, Guidelines/Decisions, бюджеты/использование |
| 6 | `2026-09-16-web-github-release.md` | Утверждённый Web UI, необязательный GitHub, диагностику, миграции/резервное копирование и приёмочный набор v1 |

...
Концепт: `dashboard-concept.html`.
...
Концепт: `project-view-concept.html`.
...
Концепт: `epic-view-concept.html`.
...
Концепт: `task-view-concept.html`.
...
Концепт: `approval-inbox-concept.html`.
...
Концепт: `execution-queue-concept.html`.
...
Концепт: `agent-run-detail-concept.html`.
...
Концепт: `usage-budget-concept.html`.
...
Концепт: `project-onboarding-concept.html`.
